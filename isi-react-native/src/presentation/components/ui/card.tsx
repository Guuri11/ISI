...
function CardTitle({
    ...
    return (
        <Text
            ...
            aria-level={3}
            className={cn(
                "text-2xl text-card-foreground font-nunito font-semibold leading-none tracking-tight",
                className,
            )}
            {...props}
        />
...
function CardDescription({
    ...
    return (
        <Text className={cn("text-sm font-nunito text-muted-foreground", className)} {...props} />
    );
}
